...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #00002;">
              <div class="col-sm-12 col-md">
                <br>
                <br>
                <br>
                <div class="heading  text-center my-5 row justify-content-center">
                  <h3>Welcome to Finix</h3>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2023. Made by <b>DIMPLE M RATHORE</b> </p>
      </footer>
